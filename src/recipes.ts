...
function buildRecipes(): AgentRecipe[] {
  ...
  const recipes: AgentRecipe[] = [
    {
      ...
      icon: iconUrl("claude"),
      tested: true,
      note: "Uses Claude Code installed on this machine, with your existing sign-in and settings.",
    ...
    },
    {
      ...
      icon: iconUrl("codex"),
      tested: true,
      note: "Uses Codex installed on this machine, with your existing sign-in or API key. Choose 'agent' to allow edits without asking, or 'read-only' for discussion without changes.",
    ...
    },
    {
      ...
      icon: iconUrl("gemini"),
      tested: true,
      note: "Uses Gemini installed on this machine, with your existing sign-in or API key. Choose the model before the vibemate joins.",
    ...
    },
    {
      ...
      icon: iconUrl("cursor"),
      tested: true,
      note: "Uses Cursor installed on this machine, with your existing sign-in or API key. Choose 'agent' to allow edits without asking, or 'ask' for questions without changes. Model choices appear after joining.",
      modelPresets: [],
      defaultModel: null,
      effortPresets: [],
      defaultEffort: null,
    ...
    },
    {
      ...
      tested: false,
      note: "Uses the providers and models you have set up in OpenCode. Choose 'plan' to discuss without editing, or 'build' to make changes. Permission requests appear in the room, according to your OpenCode settings.",
      modelPresets: [],
      defaultModel: null,
      effortPresets: [],
      defaultEffort: null,
    ...
    },
    {
      ...
      tested: false,
      note: "Uses GitHub Copilot installed on this machine, with your existing sign-in. Choose the model before joining. Modes include agent, plan and autopilot; 'allow_all' controls whether actions ask for permission.",
      modelPresets: ["auto"],
      defaultModel: null,
      effortPresets: [],
      defaultEffort: null,
    ...
    },
    {
      ...
      icon: iconUrl("grok"),
      tested: true,
      note: "Uses Grok installed on this machine, with your existing sign-in or API key. Choose 'ask-first' to approve each action, or 'always-approve' to allow actions without asking. Changing the mode restarts the session with its notes kept. Model and reasoning effort can be changed in the session settings.",
    ...
    },
    {
      ...
      icon: iconUrl("hermes"),
      tested: true,
      note: "Uses the provider and model you have set up in Hermes. Mode 'default' asks before edits; 'accept_edits' allows edits in the working folder and temporary files; 'dont_ask' allows edits except to sensitive paths. Any remaining permission requests appear in the room.",
      modelPresets: [],
      defaultModel: null,
      effortPresets: [],
      defaultEffort: null,
  ...
  if (fakeAgent) {
    ...
    recipes.push({
      ...
      icon: "",
      tested: false,
      note: "A test vibemate with scripted replies, available only when test mode is enabled.",
      modelPresets: [],
      defaultModel: null,
      effortPresets: [],
      defaultEffort: null,
